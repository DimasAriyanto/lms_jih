<x-layout>
    ...
    <div>
        <a href="https://api.whatsapp.com/send?phone=6285392042530"
            class="btn-floating whatsapp font-semibold tracking-wide align-middle transition duration-300
            ...
            <div class="relative bottom-44 ">
                <div class="absolute flex lg:gap-40 w-full justify-center user">
                    ...
                    <div class="box-border text-[#133781] shadow-lg rounded-3xl text-center h-28 w-40 bg-white ">
                        <h1 class="pt-6 font-semibold text-[#133781] lg:text-3xl sm:text-base">{{ $jumlah_mentor }}</h1>
