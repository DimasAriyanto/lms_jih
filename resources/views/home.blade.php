        ...
        <div class="container">
            <div class="px-8">
                ...
                <div class="flex gap-4">
                    <div class="box-border text-white rounded-bl-3xl text-center rounded-tr-3xl h-23 w-32  bg-[#116E63]">
                    ...
                    <div class="card w-96 glass pt-7">
                        ...
                        <div class="card-body px-3 py-5 w-full justify-center bg-white">
                            <div class="flex">
                                ...
                                <div class="button-close card-action shrink-0">
                                    <button
                                        class="btn text-sm btn-primary text-white rounded-full px-3 ">Ditutup</button>
                                </div>
                            </div>
                            <h4 class="text-sm text-slate-400 pt-2">Rp 100.000</h4>
                            <div class="flex">
