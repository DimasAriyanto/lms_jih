@foreach ($data_pelatihan as $pelatihan)
    <div class="card">
        <img src="{{ asset('images/patient-1.jpg') }}" alt="{{ $pelatihan['nama'] }}" class="rounded-t-2xl">
        <div class="card-body px-3 py-5 w-full bg-white">
            ...
            <div class="flex">
                ...
                <h2 class="pt-3 px-2 text-xs font-medium">{{ $pelatihan['tanggal_pelaksanaan'] }} ({{ $pelatihan['jam_mulai'] }} - {{ $pelatihan['jam_selesai'] }} WIB)</h2>
            </div>
            <div class="flex">
