        ...
        <div class="flex items-center px-4">
            ...
            <nav id="nav-menu"
                ...
                <ul class="block lg:flex">
                    <li>
                        <a href="#Beranda" class="mx-8 flex py-2 text-dark">Beranda</a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="{{ route('pelatihan.index')}}" class="mx-8 flex py-2 text-base text-dark">Pelatihan</a>
                    </li>
                    <li>
                        <a href="#contact"
                    ...
                    <div class="flex self-end gap-4 mx-8 masuk">
                        <li>
                            <a href="{{ route('filament.app.auth.login') }}">
                                <button class="btn rounded-2xl px-6 py-2 text-white
                                    ">Masuk</button>
                            </a>
                        </li>
                        <li class="daftar">
